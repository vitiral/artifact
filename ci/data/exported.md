...
<b>file:</b> /home/rett/open/artifact/design/data/purpose.md<br>
<b>impl:</b> not directly implemented<br>
...
<b>file:</b> /home/rett/open/artifact/design/purpose.md<br>
<b>impl:</b> not directly implemented<br>
...
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.secure</span>: this is definitely TODO, not sure how it will be accomplished ATM. Probably just require non-local host hosting to require a password and use HTTPS (nothing crazy).
...
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.backend</span>: this will be a simple json-rpc server which uses the <a style="font-weight: bold; color: #FF851B" title="REQ-DATA" href="#REQ-DATA">REQ-data</a> crate
  ...
  handling.
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.frontend</span>: the frontend will be a single page application which
...
<b>file:</b> /home/rett/open/artifact/design/cli.md<br>
<b>impl:</b> /home/rett/open/artifact/src/lib.rs[59]Secondary{".check": /home/rett/open/artifact/src/check.rs[34], ".fmt": /home/rett/open/artifact/src/fmt.rs[38], ".serve": /home/rett/open/artifact/src/serve/mod.rs[16]}<br>
...
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.init</span>: Initialize a project for using artifact. This is pretty basic, just need
  a `.art` folder with a `settings.toml` and an initial `design/` folder.
- <span title="/home/rett/open/artifact/src/check.rs[34]" style="font-weight: bold; color: #0074D9">.check</span>: checking for errors AND warnings with a return code if there is an error.
    - If there are only warnings the return code == 2. Otherwise it == 1.
- <span title="/home/rett/open/artifact/src/fmt.rs[38]" style="font-weight: bold; color: #0074D9">.fmt</span>: auto format the project.
...
- <span title="/home/rett/open/artifact/src/serve/mod.rs[16]" style="font-weight: bold; color: #0074D9">.serve</span>: the command to start the web backend.
...
<b>parts:</b><br>
<b>file:</b> /home/rett/open/artifact/design/cli.md<br>
<b>impl:</b> /home/rett/open/artifact/src/ls.rs[16]Secondary{".args": /home/rett/open/artifact/src/ls.rs[31], ".color_name": /home/rett/open/artifact/src/ls.rs[597], ".color_spc": /home/rett/open/artifact/src/ls.rs[574], ".color_tst": /home/rett/open/artifact/src/ls.rs[586]}<br>
...
## <span title="/home/rett/open/artifact/src/ls.rs[31]" style="font-weight: bold; color: #0074D9">.args</span>: Arguments
...
- `completed/tested`: flags which control what percentage completed/tested to
  display
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.long</span>: the `-l` flag prints the artifact in "long" form. Without it it
  is printed in <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.table</span> form.

## <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.color</span>: Color
...
For <span title="/home/rett/open/artifact/src/ls.rs[574]" style="font-weight: bold; color: #0074D9">.color_spc</span>, the levels are:
- `( 100%,  70%,    40%,  0%)`: percentage spc
- `(    3,    2,      1,   0)`: points
- `(green, blue, yellow, red)`: colors

For <span title="/home/rett/open/artifact/src/ls.rs[586]" style="font-weight: bold; color: #0074D9">.color_tst</span>, the levels are:
- `( 100%,    50%,  0%)`: percentage tst
- `(    2,      1,   0)`: points
- `(green, yellow, red)`: colors for tst

For <span title="/home/rett/open/artifact/src/ls.rs[597]" style="font-weight: bold; color: #0074D9">.color_name</span> you add the two points together:
- 5: Name is Green
- 3-4: name is blue
- 1-2: name is yellow
- 0: name is red
...
<li><a style="font-weight: bold; color: #FF851B" title="REQ-DATA" href="#REQ-DATA">REQ-data</a></li>
<b>parts:</b><br>
<b>file:</b> /home/rett/open/artifact/design/data/family.md<br>
<b>impl:</b> Secondary{".lint_partof_exists": /home/rett/open/artifact/artifact-data/src/project.rs[163], ".lint_types": /home/rett/open/artifact/artifact-data/src/project.rs[183]}<br>
...
- <span title="/home/rett/open/artifact/artifact-data/src/project.rs[163]" style="font-weight: bold; color: #0074D9">.lint_partof_exists</span>: Make sure any partof references actually exist.
- <span title="/home/rett/open/artifact/artifact-data/src/project.rs[183]" style="font-weight: bold; color: #0074D9">.lint_types</span>: Make sure that `partof` links are only made between valid types.

## <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.auto</span>: Auto Relationships
...
major components:
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.view</span>: the user should be able to view an artifact and its relationship to other artifacts.
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.edit</span>: the user should be able to create, modify and delete artifacts.
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.search</span>: the user should be able to search artifacts and easily see how all artifacts
...
<b>file:</b> /home/rett/open/artifact/design/data/implemented.md<br>
<b>impl:</b> not directly implemented<br>
...
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.done</span>: the artifact can define itself as done. If it does this, it must
  not have any subnames and must not be implemented (linked) in source.
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.subnames</span>: subnames can be defined in the `text` field of the artifact
...
<b>parts:</b><br>
<b>file:</b> /home/rett/open/artifact/design/data/purpose.md<br>
<b>impl:</b> /home/rett/open/artifact/artifact-ser/src/lint.rs[16]<br>
...
<b>file:</b> /home/rett/open/artifact/design/data/modify.md<br>
<b>impl:</b> /home/rett/open/artifact/artifact-data/src/modify.rs[0]Secondary{".backup": /home/rett/open/artifact/artifact-data/src/modify.rs[229]}<br>
...
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.compare_id</span>: compare the `orig_hash` of the requested changes to the hashes
...
- <span title="/home/rett/open/artifact/artifact-data/src/modify.rs[229]" style="font-weight: bold; color: #0074D9">.backup</span>: backup files by moving them to (for example) `path/to/file.md` ->
...
<li><a style="font-weight: bold; color: #0074D9" title="TST-UNIT" href="#TST-UNIT">TST-unit</a></li>
<b>file:</b> /home/rett/open/artifact/design/data/modify.md<br>
<b>impl:</b> /home/rett/open/artifact/artifact-data/src/modify.rs[184]<br>
...
<li><a style="font-weight: bold; color: #FF851B" title="TST-FUZZ" href="#TST-FUZZ">TST-fuzz</a></li>
<li><a style="font-weight: bold; color: #0074D9" title="TST-UNIT" href="#TST-UNIT">TST-unit</a></li>
<b>file:</b> /home/rett/open/artifact/design/data/name.md<br>
<b>impl:</b> /home/rett/open/artifact/artifact-ser/src/name.rs[16]Secondary{".attrs": /home/rett/open/artifact/artifact-ser/src/name.rs[210], ".type": /home/rett/open/artifact/artifact-ser/src/name.rs[98]}<br>
<b>spc:</b>100.00&nbsp;&nbsp;<b>tst:</b>70.80<br>
<hr>
</details>
...
## <span title="/home/rett/open/artifact/artifact-ser/src/name.rs[98]" style="font-weight: bold; color: #0074D9">.type</span>:  Artifact Type
...
## <span title="/home/rett/open/artifact/artifact-ser/src/name.rs[210]" style="font-weight: bold; color: #0074D9">.attrs</span>: Attributes/Getters
...
digraph G {
    ...
    subgraph cluster_src {
        ...
        start -> <a style="font-weight: bold; color: #0074D9" title="SPC-READ-IMPL" href="#SPC-READ-IMPL">SPC-read-impl</a>;
    }
    subgraph cluster_artifacts {
        label=<<b>parse artifacts</b>>;
        start -> <a style="font-weight: bold; color: #3DA03D" title="SPC-READ-RAW" href="#SPC-READ-RAW">SPC-read-raw</a>
            -> <a style="font-weight: bold; color: #0074D9" title="SPC-READ-FAMILY" href="#SPC-READ-FAMILY">SPC-read-family</a>;
        "SPC-DATA-RAW";
    }
    ...
    "SPC-DATA-SRC" -> <a style="font-weight: bold; color: #0074D9" title="SPC-READ-ARTIFACT" href="#SPC-READ-ARTIFACT">SPC-read-artifact</a>;
...
<li><a style="font-weight: bold; color: #0074D9" title="TST-UNIT" href="#TST-UNIT">TST-unit</a></li>
<b>file:</b> /home/rett/open/artifact/design/data/artifact.md<br>
<b>impl:</b> /home/rett/open/artifact/artifact-data/src/artifact.rs[17]Secondary{".build": /home/rett/open/artifact/artifact-data/src/artifact.rs[57], ".completed": /home/rett/open/artifact/artifact-data/src/graph.rs[71], ".graph": /home/rett/open/artifact/artifact-data/src/graph.rs[33], ".lint_done": /home/rett/open/artifact/artifact-data/src/project.rs[214], ".lint_text": /home/rett/open/artifact/artifact-data/src/project.rs[300], ".lint_text_refs": /home/rett/open/artifact/artifact-data/src/project.rs[335], ".load": /home/rett/open/artifact/artifact-data/src/artifact.rs[33]}<br>
...
# <span title="/home/rett/open/artifact/artifact-data/src/artifact.rs[33]" style="font-weight: bold; color: #0074D9">.load</span>: calculate pieces from ArtifactRaw only
...
# <span title="/home/rett/open/artifact/artifact-data/src/artifact.rs[57]" style="font-weight: bold; color: #0074D9">.build</span>: build the artifact from its parts
...
## <span title="/home/rett/open/artifact/artifact-data/src/graph.rs[33]" style="font-weight: bold; color: #0074D9">.graph</span>: construction of the graph
...
## <span title="/home/rett/open/artifact/artifact-data/src/graph.rs[71]" style="font-weight: bold; color: #0074D9">.completed</span>: compute the `Completed` objects.
...
## Lints
- <span title="/home/rett/open/artifact/artifact-data/src/project.rs[300]" style="font-weight: bold; color: #0074D9">.lint_text</span>: ensure that the artifat's text is valid in all of the
  formats. For markdown, this means ensuring that nothing would be parsed
  as "a new artifact" or the "end of metadata" blocks.
- <span title="/home/rett/open/artifact/artifact-data/src/project.rs[214]" style="font-weight: bold; color: #0074D9">.lint_done</span>: ensure that done and subnames are not both defined.
- <span title="/home/rett/open/artifact/artifact-data/src/project.rs[335]" style="font-weight: bold; color: #0074D9">.lint_text_refs</span>: ensure that soft references (`[[ART-name(.sub)]]`)
...
<li><a style="font-weight: bold; color: #0074D9" title="SPC-READ" href="#SPC-READ">SPC-read</a></li>
<b>parts:</b><br>
<b>file:</b> /home/rett/open/artifact/design/data/cache.md<br>
<b>impl:</b> not directly implemented<br>
<b>spc:</b>0.00&nbsp;&nbsp;<b>tst:</b>0.00<br>
<hr>
</details>
...
<li><a style="font-weight: bold; color: #0074D9" title="TST-UNIT" href="#TST-UNIT">TST-unit</a></li>
<b>file:</b> /home/rett/open/artifact/design/data/family.md<br>
<b>impl:</b> /home/rett/open/artifact/artifact-ser/src/family.rs[16]Secondary{".auto": /home/rett/open/artifact/artifact-ser/src/family.rs[159], ".auto_partof": /home/rett/open/artifact/artifact-ser/src/family.rs[97], ".deauto": /home/rett/open/artifact/artifact-ser/src/lib.rs[313], ".parent": /home/rett/open/artifact/artifact-ser/src/family.rs[85]}<br>
<b>spc:</b>100.00&nbsp;&nbsp;<b>tst:</b>70.80<br>
<hr>
</details>
...
```dot
digraph G {
    <span title="/home/rett/open/artifact/artifact-ser/src/family.rs[85]" style="font-weight: bold; color: #0074D9">.parent</span> -> { "if" [label="if elem-len > 1"; shape=diamond] };
    ...
    <span title="/home/rett/open/artifact/artifact-ser/src/family.rs[97]" style="font-weight: bold; color: #0074D9">.auto_partof</span> -> { if_req [label="type is REQ"; shape=diamond] };
...
# <span title="/home/rett/open/artifact/artifact-ser/src/family.rs[159]" style="font-weight: bold; color: #0074D9">.auto</span>
...
# <span title="/home/rett/open/artifact/artifact-ser/src/lib.rs[313]" style="font-weight: bold; color: #0074D9">.deauto</span>
...
<li><a style="font-weight: bold; color: #0074D9" title="TST-UNIT" href="#TST-UNIT">TST-unit</a></li>
<b>file:</b> /home/rett/open/artifact/design/data/implemented.md<br>
<b>impl:</b> /home/rett/open/artifact/artifact-data/src/implemented.rs[16]Secondary{".join": /home/rett/open/artifact/artifact-data/src/implemented.rs[100], ".lint_done": /home/rett/open/artifact/artifact-data/src/project.rs[252], ".lint_exists": /home/rett/open/artifact/artifact-data/src/project.rs[264], ".lint_subname_exists": /home/rett/open/artifact/artifact-data/src/project.rs[278], ".load": /home/rett/open/artifact/artifact-data/src/implemented.rs[65]}<br>
<b>spc:</b>100.00&nbsp;&nbsp;<b>tst:</b>70.80<br>
<hr>
</details>
...
### <span title="/home/rett/open/artifact/artifact-data/src/implemented.rs[65]" style="font-weight: bold; color: #0074D9">.load</span>: Loading Locations
...
- <span title="/home/rett/open/artifact/artifact-data/src/project.rs[252]" style="font-weight: bold; color: #0074D9">.lint_done</span>: an artifact with its `done` field set is also linked
  in code.
- <span title="/home/rett/open/artifact/artifact-data/src/project.rs[264]" style="font-weight: bold; color: #0074D9">.lint_exists</span>: the artifact name does not exists but it does not specify the
  linked
- <span title="/home/rett/open/artifact/artifact-data/src/project.rs[278]" style="font-weight: bold; color: #0074D9">.lint_subname_exists</span>: the artifact name exists but the artifact does not specify
  the linked subname.

### <span title="/home/rett/open/artifact/artifact-data/src/implemented.rs[100]" style="font-weight: bold; color: #0074D9">.join</span>: Joining Locations
...
<b>file:</b> /home/rett/open/artifact/design/data/raw.md<br>
<b>impl:</b> not directly implemented<br>
...
<li><a style="font-weight: bold; color: #3DA03D" title="TST-READ-RAW" href="#TST-READ-RAW">TST-read-raw</a></li>
<b>file:</b> /home/rett/open/artifact/design/data/raw.md<br>
<b>impl:</b> /home/rett/open/artifact/artifact-data/src/raw.rs[176]<br>
<b>spc:</b>100.00&nbsp;&nbsp;<b>tst:</b>100.00<br>
<hr>
</details>
...
<li><a style="font-weight: bold; color: #FF851B" title="REQ-DATA" href="#REQ-DATA">REQ-data</a></li>
<b>parts:</b><br>
<b>file:</b> /home/rett/open/artifact/design/data/structs.md<br>
<b>impl:</b> Secondary{".artifact": /home/rett/open/artifact/artifact-lib/src/lib.rs[51], ".artifact_im": /home/rett/open/artifact/artifact-lib/src/lib.rs[231], ".artifact_op": /home/rett/open/artifact/artifact-lib/src/lib.rs[301]}<br>
<b>spc:</b>50.00&nbsp;&nbsp;<b>tst:</b>0.00<br>
<hr>
</details>
...
#### <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.artifact_raw</span>: ArtifactRaw: (stored with key of `Name`)
- done: `Option[String]`
- partof: `Option[HashSet[Name]]`
- text: `Option[TextRaw]`

#### <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.text_raw</span>: TextRaw: just a newtype with some serialization guarantees
...
#### <span title="/home/rett/open/artifact/artifact-lib/src/lib.rs[301]" style="font-weight: bold; color: #0074D9">.artifact_op</span>: ArtifactOp:
...
#### <span title="/home/rett/open/artifact/artifact-lib/src/lib.rs[231]" style="font-weight: bold; color: #0074D9">.artifact_im</span>: ArtifactIm:
- name: `Name`
- file: `PathAbs`
...
**Artifact**: (<span title="/home/rett/open/artifact/artifact-lib/src/lib.rs[51]" style="font-weight: bold; color: #0074D9">.artifact</span>) the artifact is the primary exported type. It contains:
...
<b>parts:</b><br>
<b>file:</b> /home/rett/open/artifact/design/data/purpose.md<br>
<b>impl:</b> /home/rett/open/artifact/artifact-test/src/framework.rs[16]<br>
<b>spc:</b>100.00&nbsp;&nbsp;<b>tst:</b>100.00<br>
<hr>
</details>
...
<b>parts:</b><br>
<b>file:</b> /home/rett/open/artifact/design/purpose.md<br>
<b>impl:</b> /home/rett/open/artifact/artifact-test/src/lib.rs[21]Secondary{".artifact": /home/rett/open/artifact/tests/data_artifact.rs[18], ".family": /home/rett/open/artifact/tests/data_family.rs[18], ".name": /home/rett/open/artifact/tests/data_name.rs[18], ".raw_name": /home/rett/open/artifact/tests/data_raw_names.rs[18], ".read_impl": /home/rett/open/artifact/tests/data_implemented.rs[18]}<br>
...
# Implementations
- <span title="/home/rett/open/artifact/tests/data_raw_names.rs[18]" style="font-weight: bold; color: #0074D9">.raw_name</span>
- <span title="/home/rett/open/artifact/tests/data_name.rs[18]" style="font-weight: bold; color: #0074D9">.name</span>
- <span title="/home/rett/open/artifact/tests/data_family.rs[18]" style="font-weight: bold; color: #0074D9">.family</span>
- <span title="/home/rett/open/artifact/tests/data_implemented.rs[18]" style="font-weight: bold; color: #0074D9">.read_impl</span>
- <span title="/home/rett/open/artifact/tests/data_artifact.rs[18]" style="font-weight: bold; color: #0074D9">.artifact</span>
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.read</span>
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.modify</span>
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.modify_update</span>
...
<b>parts:</b><br>
<b>file:</b> /home/rett/open/artifact/design/data/artifact.md<br>
<b>impl:</b> /home/rett/open/artifact/tests/data_interop.rs[17]Secondary{".basic": /home/rett/open/artifact/tests/data_interop.rs[99], ".design_only": /home/rett/open/artifact/tests/data_interop.rs[93], ".empty": /home/rett/open/artifact/tests/data_interop.rs[75], ".lints": /home/rett/open/artifact/tests/data_interop.rs[105], ".source_invalid": /home/rett/open/artifact/tests/data_interop.rs[87], ".source_only": /home/rett/open/artifact/tests/data_interop.rs[81]}<br>
<b>spc:</b>100.00&nbsp;&nbsp;<b>tst:</b>100.00<br>
<hr>
</details>
...
- <span title="/home/rett/open/artifact/tests/data_interop.rs[75]" style="font-weight: bold; color: #0074D9">.empty</span>: `empty` project that contains only empty artifact files.
  and no source code.
- <span title="/home/rett/open/artifact/tests/data_interop.rs[81]" style="font-weight: bold; color: #0074D9">.source_only</span>: a project containing only source code (no design docs).
- <span title="/home/rett/open/artifact/tests/data_interop.rs[87]" style="font-weight: bold; color: #0074D9">.source_invalid</span>: a project containing invalid source code (invalid links).
- <span title="/home/rett/open/artifact/tests/data_interop.rs[93]" style="font-weight: bold; color: #0074D9">.design_only</span>: a project containing only design documents (none of the
...
- <span title="/home/rett/open/artifact/tests/data_interop.rs[99]" style="font-weight: bold; color: #0074D9">.basic</span>: a basic project with minimal artifacts, some implemented in
  source code.
...
- <span title="/home/rett/open/artifact/tests/data_interop.rs[105]" style="font-weight: bold; color: #0074D9">.lints</span>: a basic project to test lints
...
<b>parts:</b><br>
<b>file:</b> /home/rett/open/artifact/design/data/raw.md<br>
<b>impl:</b> /home/rett/open/artifact/artifact-test/src/raw.rs[16]<br>
<b>spc:</b>100.00&nbsp;&nbsp;<b>tst:</b>100.00<br>
<hr>
</details>
...
<b>parts:</b><br>
<b>file:</b> /home/rett/open/artifact/design/purpose.md<br>
<b>impl:</b> /home/rett/open/artifact/artifact-test/src/lib.rs[20]Secondary{".artifact": /home/rett/open/artifact/tests/data_artifact.rs[17], ".family": /home/rett/open/artifact/tests/data_family.rs[17], ".name": /home/rett/open/artifact/tests/data_name.rs[17], ".raw_name": /home/rett/open/artifact/tests/data_raw_names.rs[17], ".read_impl": /home/rett/open/artifact/tests/data_implemented.rs[17]}<br>
...
# Implementations
- <span title="/home/rett/open/artifact/tests/data_raw_names.rs[17]" style="font-weight: bold; color: #0074D9">.raw_name</span>
- <span title="/home/rett/open/artifact/tests/data_name.rs[17]" style="font-weight: bold; color: #0074D9">.name</span>
- <span title="/home/rett/open/artifact/tests/data_family.rs[17]" style="font-weight: bold; color: #0074D9">.family</span>: this also inclused auto partofs as well as collapsing/expanding
  partof.
- <span title="/home/rett/open/artifact/tests/data_implemented.rs[17]" style="font-weight: bold; color: #0074D9">.read_impl</span>
- <span title="/home/rett/open/artifact/tests/data_artifact.rs[17]" style="font-weight: bold; color: #0074D9">.artifact</span>
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.modify</span>
- <span title="Not Implemented" style="font-weight: bold; color: #FF4136">.modify_update</span>
